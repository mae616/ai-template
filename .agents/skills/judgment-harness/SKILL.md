...
- 学びや決定を**どのレイヤー（AGENTS.md / rule / どのskill）に置くか**迷ったとき
...
| 層 | 実体 | 性質 | 例 |
|---|---|---|---|
| **ベース層**（普遍） | `AGENTS.md` ＋ `.Codex/rules/*` ＋ 汎用スキル群 | how・判断ロジック | TDD、命名規約、レビュー手順 |
...
| 学びの性質 | 置き場所 |
|---|---|
| 全プロジェクトで普遍に効く手順・判断ロジック | ベース層（`AGENTS.md` / `rules`）→ さらに ai-template へ送り状（`doc/output/to-template.md`） |
